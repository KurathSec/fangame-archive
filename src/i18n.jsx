...
window.TRANSLATIONS = {
  "en": {
    ...
    "date_filter_label": "Release Date ({count})",
    "date_filter_add": "Add",
    "date_filter_help": "Pick a start and/or end date and add the period. Click a period to switch include → exclude; click again to remove.",
    ...
    "collection_naming": "Naming",
    "mode_none": "None",
    "mode_preset": "Preset",
    "mode_custom": "Custom",
    "mode_none_help": "No name or description — shareable instantly by link, no review.",
    "mode_preset_help": "Pick a ready-made name; no description — shareable instantly by link, no review.",
    "mode_custom_help": "Write your own name and description. Sharing requires submitting it to the public library, which is reviewed first.",
    "choose_preset": "Choose a preset…",
    "show_owner_label": "Show my username on the shared page",
    "mode_custom_public_parent": "The parent collection is public — a custom name/description will only appear there after review.",
    "collection_created_pending": "Saved — the custom name/description will show publicly after review",
    "badge_pending": "Pending review",
    "badge_rejected": "Rejected",
    "vis_public_folder_sub": "Lists the folder and its sub-collections in the public library after review.",
    "add_subcollection": "Add sub-collection",
    "add_to_collection": "Add to collection",
    "back": "Back",
    "collection_created": "Collection created",
    "collection_custom_notice": "Custom names and descriptions can only be shared through “Open to public”, which is reviewed first. A blank or preset name with no description can be shared by link instantly.",
    "collection_desc": "Description",
    "collection_desc_ph": "Describe this collection…",
    "collection_link_on": "Share link enabled",
    "collection_made_private": "Set to private",
    "collection_name": "Name",
    "collection_name_ph": "Collection name",
    "collection_saved": "Collection saved",
    "collection_submitted": "Submitted for review",
    "collection_untitled": "Untitled list",
    "confirm_delete_collection": "Delete this collection? This cannot be undone.",
    "copy_link": "Copy",
    ...
    "list_empty_sub": "Add games from any game’s “add to collection” menu.",
    "list_empty": "This list is empty",
    "main_saves": "Main saves",
    "menu": "Menu",
    "nav.public_collections": "Public Collections",
    "new_collection_cta": "New collection",
    "new_list_placeholder": "New list name (optional)",
    "no_collections": "No collections yet. Create one to organize saved games into shareable lists.",
    "optional": "optional",
    "publib_empty": "No public collections yet",
    "publib_empty_sub": "Approved public collections shared by the community will appear here.",
    "publib_error_sub": "Please try again.",
    "publib_sub": "Community-shared game lists, reviewed before they appear here.",
    "save": "Save",
    "save_to": "Save to…",
    "shared_collection": "Shared collection",
    "shared_gone_sub": "This shared collection no longer exists or is private.",
    "shared_gone_title": "Collection unavailable",
    "sharing": "Sharing",
    "submit_for_review": "Submit for public library",
    "vis_private": "Private",
    "vis_private_sub": "Only you can see this.",
    "vis_public_approved": "Live in the public library.",
    "vis_public_badge": "Public",
    "vis_public": "Open to public",
    "vis_public_pending": "Pending review.",
    "vis_public_rejected": "Rejected: ",
    "vis_public_sub": "Listed in the public library after review.",
    "vis_unlisted_blocked": "Remove the custom name/description to share by link",
    "vis_unlisted": "Share by link",
    "vis_unlisted_sub": "Anyone with the link can view. Not listed anywhere.",
    ...
    "view_upstream": "Upstream entry",
    "api_docs": "Public API",
    "api_docs_desc": "The catalog is readable by anyone, with no key and no rate limit. Every endpoint is a plain GET returning JSON, allows cross-origin requests from any site, and is cached at the edge for 10 minutes (except /api/random, which re-samples every call). Every game record carries its id, title, creator, tags, engine, release date, rating, difficulty, review count, download size and link, its page on this site, and where it was catalogued from.",
    "api_endpoints": "Endpoints",
    "api_filters": "Filters (shared by every endpoint)",
    "api_examples": "Examples",
    "api_notes": "All the filters above use one vocabulary and combine freely, on any endpoint. Tag and engine filters are tri-state, exactly like the sidebar: name a value to require it, add _all to require all of them, add _not to exclude. A filter you leave out is neutral. Date ranges stack the same way — several date_in periods widen the result, date_not carves periods out — and a game with no known release date is inside no range at all, so date_in drops it while date_not leaves it alone. A malformed parameter returns HTTP 400 with an error message rather than being silently ignored, so a typo never looks like an empty result.",
    ...
    "upload_mode_url": "Link",
    "upload_mode_file": "Upload file",
    "upload_pick": "Choose a file",
    "upload_pick_sub": "ZIP · RAR · 7z · TAR · GZ · EXE — up to 500 MB",
    "upload_uploading": "Uploading…",
    "upload_verifying": "Verifying…",
    "upload_done_help": "Uploaded — the file is attached to this submission.",
    "upload_remove": "Remove uploaded file",
    "upload_retry": "Try again",
    "upload_failed": "Upload failed",
    "upload_required_error": "Please upload the game file first.",
    "upload_bad_type": "Unsupported file type",
    "upload_too_large": "File exceeds the 500 MB limit",
    "upload_shot_too_large": "Image exceeds the 8 MB limit",
    "upload_shot_title": "Upload an image",
    "upload_shot_busy": "Please wait — a screenshot is still uploading.",
  ...
  "zh-CN": {
    ...
    "release_date": "发布日期",
    "sort_date": "发布日期",
    "date_filter_label": "发布时间段 ({count})",
    "date_filter_add": "添加",
    "date_filter_help": "选择起止日期添加时间段;点击时间段可切换 包含 → 排除,再点一次移除。",
    "special_thanks": "特别鸣谢",
    "technical_stack": "技术栈",
    "frontend_core": "前端核心",
    ...
    "collection_naming": "命名方式",
    "mode_none": "无",
    "mode_preset": "预设",
    "mode_custom": "自定义",
    "mode_none_help": "不设名称和描述——可直接通过链接分享，无需审核。",
    "mode_preset_help": "从预设中选一个名称，无描述——可直接通过链接分享，无需审核。",
    "mode_custom_help": "自己填写名称和描述。要分享须提交到公开库并经审核。",
    "choose_preset": "选择一个预设…",
    "show_owner_label": "在分享页面显示我的用户名",
    "mode_custom_public_parent": "母收藏夹已公开——自定义名称/描述需审核通过后才会在公开页面显示。",
    "collection_created_pending": "已保存——自定义名称/描述将在审核通过后公开显示",
    "badge_pending": "待审核",
    "badge_rejected": "已拒绝",
    "vis_public_folder_sub": "审核通过后，该收藏夹及其子收藏夹将展示在公开库中。",
    "add_subcollection": "添加子收藏集",
    "add_to_collection": "添加到收藏集",
    "back": "返回",
    "collection_created": "收藏集已创建",
    "collection_custom_notice": "自定义名称和描述只能通过“公开”方式分享，且需先经过审核。使用空白或预设名称且无描述的收藏集可立即通过链接分享。",
    "collection_desc": "描述",
    "collection_desc_ph": "描述这个收藏集…",
    "collection_link_on": "分享链接已启用",
    "collection_made_private": "已设为私密",
    "collection_name": "名称",
    "collection_name_ph": "收藏集名称",
    "collection_saved": "收藏集已保存",
    "collection_submitted": "已提交审核",
    "collection_untitled": "未命名列表",
    "confirm_delete_collection": "删除此收藏集？此操作无法撤销。",
    "copy_link": "复制",
    ...
    "edit": "编辑",
    "edit_share": "编辑并分享",
    "list_empty_sub": "从任意游戏的“添加到收藏集”菜单中添加游戏。",
    "list_empty": "此列表为空",
    "main_saves": "主收藏",
    "menu": "菜单",
    "nav.public_collections": "公开收藏集",
    "new_collection_cta": "新建收藏集",
    "new_list_placeholder": "新列表名称（可选）",
    "no_collections": "还没有收藏集。创建一个，将已保存的游戏整理成可分享的列表。",
    "optional": "可选",
    "publib_empty": "暂无公开收藏集",
    "publib_empty_sub": "社区分享并经审核通过的公开收藏集将显示在此处。",
    "publib_error_sub": "请重试。",
    "publib_sub": "社区分享的游戏列表，经审核后在此显示。",
    "save": "保存",
    "save_to": "保存到…",
    "shared_collection": "已分享的收藏集",
    "shared_gone_sub": "此分享的收藏集已不存在或为私密。",
    "shared_gone_title": "收藏集不可用",
    "sharing": "分享",
    "submit_for_review": "提交至公开库",
    "vis_private": "私密",
    "vis_private_sub": "只有您可以看到。",
    "vis_public_approved": "已在公开库中展示。",
    "vis_public_badge": "公开",
    "vis_public": "公开",
    "vis_public_pending": "等待审核。",
    "vis_public_rejected": "已拒绝：",
    "vis_public_sub": "审核通过后在公开库中列出。",
    "vis_unlisted_blocked": "移除自定义名称/描述后才能通过链接分享",
    "vis_unlisted": "通过链接分享",
    "vis_unlisted_sub": "任何拥有链接的人都可查看。不会在任何地方列出。",
    "your_collections": "您的收藏集",
    "share_config": "分享配置",
    "add_games": "添加游戏",
    ...
    "view_upstream": "原始条目",
    "api_docs": "公开 API",
    "api_docs_desc": "目录对所有人开放读取，无需密钥、不限速率。所有接口都是普通的 GET 请求并返回 JSON，允许任意站点跨域调用，边缘缓存 10 分钟（/api/random 除外，它每次调用都会重新抽取）。每条游戏记录都包含 ID、标题、作者、标签、引擎、发布日期、评分、难度、评价数、文件大小与下载链接、本站页面地址，以及它的收录来源。",
    "api_endpoints": "接口",
    "api_filters": "筛选参数（所有接口通用）",
    "api_examples": "示例",
    "api_notes": "以上筛选参数共用同一套语法，可在任意接口上自由组合。标签和引擎筛选是三态的，与侧边栏完全一致：直接写值表示需要包含，加 _all 表示必须全部满足，加 _not 表示排除；不写的参数则不参与筛选。日期区间同理可以叠加——多个 date_in 会并集扩大结果，date_not 则从中挖去时段；没有已知发布日期的游戏不属于任何区间，因此 date_in 会把它排除，而 date_not 不会影响它。参数写错会返回 HTTP 400 和错误说明，而不是被静默忽略，所以打错字不会看起来像“没有结果”。",
    ...
    "upload_pick": "选择文件",
    "upload_pick_sub": "ZIP · RAR · 7z · TAR · GZ · EXE，最大 500 MB",
    "upload_uploading": "上传中…",
    "upload_verifying": "校验中…",
    "upload_done_help": "已上传——文件将随本次提交一起送审。",
    "upload_remove": "移除已上传的文件",
    "upload_retry": "重试",
    "upload_failed": "上传失败",
    "upload_required_error": "请先上传游戏文件。",
    "upload_bad_type": "不支持的文件类型",
    "upload_too_large": "文件超过 500 MB 上限",
    "upload_shot_too_large": "图片超过 8 MB 上限",
    "upload_shot_title": "上传图片",
    "upload_shot_busy": "请等待截图上传完成。",
  ...
  "zh-TW": {
    ...
    "release_date": "發布日期",
    "sort_date": "發布日期",
    "date_filter_label": "發布時間段 ({count})",
    "date_filter_add": "新增",
    "date_filter_help": "選擇起止日期新增時間段;點擊時間段可切換 包含 → 排除,再點一次移除。",
    "special_thanks": "特別鳴謝",
    ...
    "mode_preset": "預設",
    "mode_custom": "自訂",
    "mode_none_help": "不設名稱和描述——可直接透過連結分享，無需審核。",
    "mode_preset_help": "從預設中選一個名稱，無描述——可直接透過連結分享，無需審核。",
    "mode_custom_help": "自行填寫名稱和描述。要分享須提交到公開庫並經審核。",
    "choose_preset": "選擇一個預設…",
    "show_owner_label": "在分享頁面顯示我的使用者名稱",
    "mode_custom_public_parent": "母收藏夾已公開——自訂名稱/描述需審核通過後才會在公開頁面顯示。",
    "collection_created_pending": "已儲存——自訂名稱/描述將在審核通過後公開顯示",
    "badge_pending": "待審核",
    "badge_rejected": "已拒絕",
    "vis_public_folder_sub": "審核通過後，該收藏夾及其子收藏夾將展示在公開庫中。",
    "add_subcollection": "新增子收藏集",
    "add_to_collection": "新增至收藏集",
    "back": "返回",
    "collection_created": "收藏集已建立",
    "collection_custom_notice": "自訂名稱和描述只能透過「公開」方式分享，且需先經過審核。使用空白或預設名稱且無描述的收藏集可立即透過連結分享。",
    "collection_desc": "描述",
    "collection_desc_ph": "描述這個收藏集…",
    "collection_link_on": "分享連結已啟用",
    "collection_made_private": "已設為私密",
    "collection_name": "名稱",
    "collection_name_ph": "收藏集名稱",
    "collection_saved": "收藏集已儲存",
    "collection_submitted": "已提交審核",
    "collection_untitled": "未命名列表",
    "confirm_delete_collection": "刪除此收藏集？此操作無法復原。",
    "copy_link": "複製",
    "copy_share_link": "複製連結",
    "create_collection": "建立收藏集",
    "create": "建立",
    "delete": "刪除",
    "edit_collection": "編輯收藏集",
    "edit": "編輯",
    "edit_share": "編輯並分享",
    "list_empty_sub": "從任意遊戲的「新增至收藏集」選單中新增遊戲。",
    "list_empty": "此列表為空",
    "main_saves": "主收藏",
    "menu": "選單",
    "nav.public_collections": "公開收藏集",
    "new_collection_cta": "新增收藏集",
    "new_list_placeholder": "新列表名稱（選填）",
    "no_collections": "還沒有收藏集。建立一個，將已儲存的遊戲整理成可分享的列表。",
    "optional": "選填",
    "publib_empty": "尚無公開收藏集",
    "publib_empty_sub": "社群分享並經審核通過的公開收藏集將顯示於此處。",
    "publib_error_sub": "請重試。",
    "publib_sub": "社群分享的遊戲列表，經審核後在此顯示。",
    "save": "儲存",
    "save_to": "儲存至…",
    "shared_collection": "已分享的收藏集",
    "shared_gone_sub": "此分享的收藏集已不存在或為私密。",
    "shared_gone_title": "收藏集無法使用",
    "sharing": "分享",
    "submit_for_review": "提交至公開庫",
    "vis_private": "私密",
    "vis_private_sub": "只有您可以看到。",
    "vis_public_approved": "已在公開庫中展示。",
    "vis_public_badge": "公開",
    "vis_public": "公開",
    "vis_public_pending": "等待審核。",
    "vis_public_rejected": "已拒絕：",
    "vis_public_sub": "審核通過後在公開庫中列出。",
    "vis_unlisted_blocked": "移除自訂名稱/描述後才能透過連結分享",
    "vis_unlisted": "透過連結分享",
    "vis_unlisted_sub": "任何擁有連結的人都可檢視。不會在任何地方列出。",
    "your_collections": "您的收藏集",
    "share_config": "分享設定",
    "add_games": "新增遊戲",
    ...
    "view_upstream": "原始條目",
    "api_docs": "公開 API",
    "api_docs_desc": "目錄對所有人開放讀取，無需金鑰、不限速率。所有介面都是一般的 GET 請求並回傳 JSON，允許任意網站跨網域呼叫，邊緣快取 10 分鐘（/api/random 除外，它每次呼叫都會重新抽取）。每筆遊戲記錄都包含 ID、標題、作者、標籤、引擎、發行日期、評分、難度、評價數、檔案大小與下載連結、本站頁面網址，以及它的收錄來源。",
    "api_endpoints": "介面",
    "api_filters": "篩選參數（所有介面通用）",
    "api_examples": "範例",
    "api_notes": "以上篩選參數共用同一套語法，可在任意介面上自由組合。標籤與引擎篩選是三態的，與側邊欄完全一致：直接寫值表示需要包含，加 _all 表示必須全部滿足，加 _not 表示排除；未填的參數則不參與篩選。日期區間同理可以疊加——多個 date_in 會聯集擴大結果，date_not 則從中挖去時段；沒有已知發行日期的遊戲不屬於任何區間，因此 date_in 會將其排除，而 date_not 不會影響它。參數寫錯會回傳 HTTP 400 與錯誤說明，而不是被靜默忽略，所以打錯字不會看起來像「沒有結果」。",
    ...
    "upload_mode_url": "連結",
    "upload_mode_file": "上傳檔案",
    "upload_pick": "選擇檔案",
    "upload_pick_sub": "ZIP · RAR · 7z · TAR · GZ · EXE，最大 500 MB",
    "upload_uploading": "上傳中…",
    "upload_verifying": "驗證中…",
    "upload_done_help": "已上傳——檔案將隨本次提交一起送審。",
    "upload_remove": "移除已上傳的檔案",
    "upload_retry": "重試",
    "upload_failed": "上傳失敗",
    "upload_required_error": "請先上傳遊戲檔案。",
    "upload_bad_type": "不支援的檔案類型",
    "upload_too_large": "檔案超過 500 MB 上限",
    "upload_shot_too_large": "圖片超過 8 MB 上限",
    "upload_shot_title": "上傳圖片",
    "upload_shot_busy": "請等待截圖上傳完成。",
  ...
  "ja": {
    ...
    "release_date": "リリース日",
    "sort_date": "リリース日",
    "date_filter_label": "リリース期間 ({count})",
    "date_filter_add": "追加",
    "date_filter_help": "開始日・終了日を選んで期間を追加。期間をクリックすると 含む → 除外 に切り替わり、もう一度クリックで削除されます。",
    ...
    "collection_naming": "名前の付け方",
    "mode_none": "なし",
    "mode_preset": "プリセット",
    "mode_custom": "カスタム",
    "mode_none_help": "名前も説明もなし — リンクで即共有でき、審査は不要です。",
    "mode_preset_help": "既製の名前を選択（説明なし）— リンクで即共有でき、審査は不要です。",
    "mode_custom_help": "名前と説明を自分で入力します。共有するには公開ライブラリへの申請（審査あり）が必要です。",
    "choose_preset": "プリセットを選択…",
    "show_owner_label": "共有ページにユーザー名を表示する",
    "mode_custom_public_parent": "親コレクションは公開中です——カスタムの名前/説明は審査後に公開ページへ表示されます。",
    "collection_created_pending": "保存しました——カスタムの名前/説明は審査後に公開されます",
    "badge_pending": "審査待ち",
    "badge_rejected": "却下",
    "vis_public_folder_sub": "審査後、このフォルダとサブコレクションが公開ライブラリに掲載されます。",
    "add_subcollection": "サブコレクションを追加",
    "add_to_collection": "コレクションに追加",
    "back": "戻る",
    "collection_created": "コレクションを作成しました",
    "collection_custom_notice": "カスタム名と説明は、先に審査される「一般公開」を通じてのみ共有できます。空欄またはプリセット名で説明のないものは、リンクですぐに共有できます。",
    "collection_desc": "説明",
    "collection_desc_ph": "このコレクションを説明…",
    "collection_link_on": "共有リンクが有効です",
    "collection_made_private": "非公開に設定しました",
    "collection_name": "名前",
    "collection_name_ph": "コレクション名",
    "collection_saved": "コレクションを保存しました",
    "collection_submitted": "審査に提出しました",
    "collection_untitled": "無題のリスト",
    "confirm_delete_collection": "このコレクションを削除しますか？この操作は取り消せません。",
    "copy_link": "コピー",
    ...
    "edit": "編集",
    "edit_share": "編集して共有",
    "list_empty_sub": "任意のゲームの「コレクションに追加」メニューからゲームを追加してください。",
    "list_empty": "このリストは空です",
    "main_saves": "メインの保存",
    "menu": "メニュー",
    "nav.public_collections": "公開コレクション",
    "new_collection_cta": "新しいコレクション",
    "new_list_placeholder": "新しいリスト名（任意）",
    "no_collections": "コレクションはまだありません。作成して、保存したゲームを共有可能なリストに整理しましょう。",
    "optional": "任意",
    "publib_empty": "公開コレクションはまだありません",
    "publib_empty_sub": "コミュニティが共有し承認された公開コレクションがここに表示されます。",
    "publib_error_sub": "もう一度お試しください。",
    "publib_sub": "コミュニティが共有したゲームリスト。審査を経てここに表示されます。",
    "save": "保存",
    "save_to": "保存先…",
    "shared_collection": "共有コレクション",
    "shared_gone_sub": "この共有コレクションはすでに存在しないか、非公開です。",
    "shared_gone_title": "コレクションを利用できません",
    "sharing": "共有",
    "submit_for_review": "公開ライブラリに申請",
    "vis_private": "非公開",
    "vis_private_sub": "あなただけが見ることができます。",
    "vis_public_approved": "公開ライブラリに掲載されています。",
    "vis_public_badge": "公開",
    "vis_public": "一般公開",
    "vis_public_pending": "審査待ちです。",
    "vis_public_rejected": "却下されました：",
    "vis_public_sub": "審査後、公開ライブラリに掲載されます。",
    "vis_unlisted_blocked": "リンクで共有するにはカスタム名／説明を削除してください",
    "vis_unlisted": "リンクで共有",
    "vis_unlisted_sub": "リンクを知っている人は誰でも閲覧できます。どこにも掲載されません。",
    "your_collections": "あなたのコレクション",
    "share_config": "設定を共有",
    "add_games": "ゲームを追加",
    ...
    "view_upstream": "収録元エントリ",
    "api_docs": "公開 API",
    "api_docs_desc": "カタログは誰でも読み取れます。キーもレート制限もありません。すべてのエンドポイントは JSON を返す通常の GET リクエストで、任意のサイトからのクロスオリジン呼び出しに対応し、エッジで 10 分間キャッシュされます（毎回サンプリングし直す /api/random を除く）。各ゲームのレコードには ID、タイトル、作者、タグ、エンジン、リリース日、評価、難易度、レビュー数、ファイルサイズとダウンロードリンク、本サイトのページ URL、そして収録元が含まれます。",
    "api_endpoints": "エンドポイント",
    "api_filters": "フィルタ（全エンドポイント共通）",
    "api_examples": "例",
    "api_notes": "上記のフィルタはすべて同じ文法を共有し、どのエンドポイントでも自由に組み合わせられます。タグとエンジンのフィルタはサイドバーとまったく同じ三状態です。値をそのまま指定すれば「含む」、_all を付ければ「すべて満たす」、_not を付ければ「除外」。指定しなかったフィルタは何も絞り込みません。日付範囲も同じように重ねられます。複数の date_in は結果を広げ、date_not は期間をくり抜きます。リリース日が不明なゲームはどの範囲にも属さないため、date_in では除外され、date_not では影響を受けません。パラメータの書式が誤っている場合は黙って無視されず HTTP 400 とエラーメッセージが返るので、打ち間違いが「結果ゼロ」に見えることはありません。",
    ...
    "upload_verifying": "確認中…",
    "upload_done_help": "アップロード完了——この投稿に添付されます。",
    "upload_remove": "アップロードしたファイルを削除",
    "upload_retry": "再試行",
    "upload_failed": "アップロードに失敗しました",
    "upload_required_error": "先にゲームファイルをアップロードしてください。",
    "upload_bad_type": "対応していないファイル形式です",
    "upload_too_large": "ファイルが 500 MB の上限を超えています",
    "upload_shot_too_large": "画像が 8 MB の上限を超えています",
    "upload_shot_title": "画像をアップロード",
    "upload_shot_busy": "スクリーンショットのアップロードが終わるまでお待ちください。",
  ...
  "ko": {
    ...
    "release_date": "출시일",
    "sort_date": "출시일",
    "date_filter_label": "출시 기간 ({count})",
    "date_filter_add": "추가",
    "date_filter_help": "시작일/종료일을 선택해 기간을 추가하세요. 기간을 클릭하면 포함 → 제외로 바뀌고, 다시 클릭하면 삭제됩니다.",
    ...
    "collection_naming": "이름 지정",
    "mode_none": "없음",
    "mode_preset": "프리셋",
    "mode_custom": "사용자 지정",
    "mode_none_help": "이름과 설명 없음 — 링크로 즉시 공유 가능, 검토 불필요.",
    "mode_preset_help": "미리 만든 이름 선택, 설명 없음 — 링크로 즉시 공유 가능, 검토 불필요.",
    "mode_custom_help": "이름과 설명을 직접 작성합니다. 공유하려면 공개 라이브러리에 제출하여 검토를 받아야 합니다.",
    "choose_preset": "프리셋 선택…",
    "show_owner_label": "공유 페이지에 내 사용자 이름 표시",
    "mode_custom_public_parent": "상위 컬렉션이 공개 상태입니다 — 사용자 지정 이름/설명은 검토 후에 공개 페이지에 표시됩니다.",
    "collection_created_pending": "저장됨 — 사용자 지정 이름/설명은 검토 후 공개됩니다",
    "badge_pending": "검토 대기 중",
    "badge_rejected": "거부됨",
    "vis_public_folder_sub": "검토 후 이 폴더와 하위 컬렉션이 공개 라이브러리에 게시됩니다.",
    "add_subcollection": "하위 컬렉션 추가",
    "add_to_collection": "컬렉션에 추가",
    "back": "뒤로",
    "collection_created": "컬렉션이 생성되었습니다",
    "collection_custom_notice": "사용자 지정 이름과 설명은 먼저 검토되는 '공개하기'를 통해서만 공유할 수 있습니다. 이름이 비어 있거나 기본값이고 설명이 없는 경우 링크로 즉시 공유할 수 있습니다.",
    "collection_desc": "설명",
    "collection_desc_ph": "이 컬렉션을 설명하세요…",
    "collection_link_on": "공유 링크가 활성화되었습니다",
    "collection_made_private": "비공개로 설정됨",
    "collection_name": "이름",
    "collection_name_ph": "컬렉션 이름",
    "collection_saved": "컬렉션이 저장되었습니다",
    "collection_submitted": "검토를 위해 제출됨",
    "collection_untitled": "제목 없는 목록",
    "confirm_delete_collection": "이 컬렉션을 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.",
    "copy_link": "복사",
    "copy_share_link": "링크 복사",
    ...
    "edit": "편집",
    "edit_share": "편집 및 공유",
    "list_empty_sub": "게임의 '컬렉션에 추가' 메뉴에서 게임을 추가하세요.",
    "list_empty": "이 목록은 비어 있습니다",
    "main_saves": "기본 저장",
    "menu": "메뉴",
    "nav.public_collections": "공개 컬렉션",
    "new_collection_cta": "새 컬렉션",
    "new_list_placeholder": "새 목록 이름 (선택 사항)",
    "no_collections": "아직 컬렉션이 없습니다. 하나 만들어 저장한 게임을 공유 가능한 목록으로 정리하세요.",
    "optional": "선택 사항",
    "publib_empty": "아직 공개 컬렉션이 없습니다",
    "publib_empty_sub": "커뮤니티가 공유하고 승인된 공개 컬렉션이 여기에 표시됩니다.",
    "publib_error_sub": "다시 시도해 주세요.",
    "publib_sub": "커뮤니티가 공유한 게임 목록으로, 검토를 거쳐 여기에 표시됩니다.",
    "save": "저장",
    "save_to": "저장 위치…",
    "shared_collection": "공유된 컬렉션",
    "shared_gone_sub": "이 공유된 컬렉션은 더 이상 존재하지 않거나 비공개입니다.",
    "shared_gone_title": "컬렉션을 사용할 수 없습니다",
    "sharing": "공유",
    "submit_for_review": "공개 라이브러리에 제출",
    "vis_private": "비공개",
    "vis_private_sub": "나만 볼 수 있습니다.",
    "vis_public_approved": "공개 라이브러리에 게시됨.",
    "vis_public_badge": "공개",
    "vis_public": "공개하기",
    "vis_public_pending": "검토 대기 중.",
    "vis_public_rejected": "거부됨: ",
    "vis_public_sub": "검토 후 공개 라이브러리에 게시됩니다.",
    "vis_unlisted_blocked": "링크로 공유하려면 사용자 지정 이름/설명을 제거하세요",
    "vis_unlisted": "링크로 공유",
    "vis_unlisted_sub": "링크가 있는 누구나 볼 수 있습니다. 어디에도 게시되지 않습니다.",
    "your_collections": "내 컬렉션",
    "share_config": "설정 공유",
    "add_games": "게임 추가",
    ...
    "view_upstream": "원본 항목",
    "api_docs": "공개 API",
    "api_docs_desc": "카탈로그는 키도 요청 제한도 없이 누구나 읽을 수 있습니다. 모든 엔드포인트는 JSON을 반환하는 일반 GET 요청이며, 어떤 사이트에서든 교차 출처 호출을 허용하고 엣지에서 10분간 캐시됩니다(호출할 때마다 다시 추첨하는 /api/random 제외). 각 게임 레코드에는 ID, 제목, 제작자, 태그, 엔진, 출시일, 평점, 난이도, 리뷰 수, 파일 크기와 다운로드 링크, 이 사이트의 페이지 주소, 그리고 수록 출처가 담겨 있습니다.",
    "api_endpoints": "엔드포인트",
    "api_filters": "필터(모든 엔드포인트 공통)",
    "api_examples": "예시",
    "api_notes": "위 필터는 모두 같은 문법을 사용하며 어떤 엔드포인트에서도 자유롭게 조합할 수 있습니다. 태그와 엔진 필터는 사이드바와 똑같이 3단계입니다. 값을 그대로 쓰면 포함, _all을 붙이면 모두 만족, _not을 붙이면 제외이며, 쓰지 않은 필터는 아무것도 걸러내지 않습니다. 날짜 범위도 같은 방식으로 쌓입니다. 여러 date_in은 결과를 넓히고 date_not은 기간을 도려냅니다. 출시일이 알려지지 않은 게임은 어떤 범위에도 속하지 않으므로 date_in에서는 빠지고 date_not의 영향은 받지 않습니다. 잘못된 매개변수는 조용히 무시되지 않고 HTTP 400과 오류 메시지를 돌려주므로, 오타가 '결과 없음'처럼 보이는 일은 없습니다.",
    ...
    "upload_pick": "파일 선택",
    "upload_pick_sub": "ZIP · RAR · 7z · TAR · GZ · EXE, 최대 500 MB",
    "upload_uploading": "업로드 중…",
    "upload_verifying": "확인 중…",
    "upload_done_help": "업로드 완료 — 이 제출에 첨부됩니다.",
    "upload_remove": "업로드한 파일 제거",
    "upload_retry": "다시 시도",
    "upload_failed": "업로드 실패",
    "upload_required_error": "먼저 게임 파일을 업로드해 주세요.",
    "upload_bad_type": "지원하지 않는 파일 형식입니다",
    "upload_too_large": "파일이 500 MB 제한을 초과합니다",
    "upload_shot_too_large": "이미지가 8 MB 제한을 초과합니다",
    "upload_shot_title": "이미지 업로드",
    "upload_shot_busy": "스크린샷 업로드가 끝날 때까지 기다려 주세요.",
  ...
  "ru": {
    ...
    "sort_date": "Дата выхода",
    "date_filter_label": "Период выхода ({count})",
    "date_filter_add": "Добавить",
    "date_filter_help": "Выберите дату начала и/или конца и добавьте период. Клик по периоду переключает включение → исключение; ещё клик — удаление.",
    ...
    "collection_naming": "Название",
    "mode_none": "Нет",
    "mode_preset": "Пресет",
    "mode_custom": "Своё",
    "mode_none_help": "Без названия и описания — можно сразу поделиться ссылкой, без проверки.",
    "mode_preset_help": "Выберите готовое название, без описания — можно сразу поделиться ссылкой, без проверки.",
    "mode_custom_help": "Своё название и описание. Чтобы поделиться, нужно отправить в публичную библиотеку на проверку.",
    "choose_preset": "Выберите пресет…",
    "show_owner_label": "Показывать моё имя пользователя на странице",
    "mode_custom_public_parent": "Родительская коллекция публичная — своё название/описание появится там только после проверки.",
    "collection_created_pending": "Сохранено — своё название/описание появится публично после проверки",
    "badge_pending": "Ожидает проверки",
    "badge_rejected": "Отклонено",
    "vis_public_folder_sub": "После проверки папка и её подколлекции появятся в публичной библиотеке.",
    "add_subcollection": "Добавить подколлекцию",
    "add_to_collection": "Добавить в коллекцию",
    "back": "Назад",
    "collection_created": "Коллекция создана",
    "collection_custom_notice": "Пользовательские названия и описания можно опубликовать только через «Открыть для всех», что сначала проходит проверку. Пустым или стандартным названием без описания можно поделиться по ссылке мгновенно.",
    "collection_desc": "Описание",
    "collection_desc_ph": "Опишите эту коллекцию…",
    "collection_link_on": "Ссылка для доступа включена",
    "collection_made_private": "Сделано приватным",
    "collection_name": "Название",
    "collection_name_ph": "Название коллекции",
    "collection_saved": "Коллекция сохранена",
    "collection_submitted": "Отправлено на проверку",
    "collection_untitled": "Список без названия",
    "confirm_delete_collection": "Удалить эту коллекцию? Это действие нельзя отменить.",
    "copy_link": "Копировать",
    "copy_share_link": "Скопировать ссылку",
    "create_collection": "Создать коллекцию",
    "create": "Создать",
    "delete": "Удалить",
    "edit_collection": "Редактировать коллекцию",
    "edit": "Изменить",
    "edit_share": "Изменить и поделиться",
    "list_empty_sub": "Добавляйте игры из меню «добавить в коллекцию» на странице любой игры.",
    "list_empty": "Этот список пуст",
    "main_saves": "Основные сохранённые",
    "menu": "Меню",
    "nav.public_collections": "Публичные коллекции",
    "new_collection_cta": "Новая коллекция",
    "new_list_placeholder": "Название нового списка (необязательно)",
    "no_collections": "Пока нет коллекций. Создайте её, чтобы упорядочить сохранённые игры в списки, которыми можно поделиться.",
    "optional": "необязательно",
    "publib_empty": "Пока нет публичных коллекций",
    "publib_empty_sub": "Одобренные публичные коллекции, которыми поделилось сообщество, появятся здесь.",
    "publib_error_sub": "Пожалуйста, попробуйте ещё раз.",
    "publib_sub": "Игровые списки, которыми поделилось сообщество, проходят проверку перед публикацией.",
    "save": "Сохранить",
    "save_to": "Сохранить в…",
    "shared_collection": "Общая коллекция",
    "shared_gone_sub": "Эта общая коллекция больше не существует или является приватной.",
    "shared_gone_title": "Коллекция недоступна",
    "sharing": "Доступ",
    "submit_for_review": "Отправить в публичную библиотеку",
    "vis_private": "Приватная",
    "vis_private_sub": "Видно только вам.",
    "vis_public_approved": "Опубликовано в публичной библиотеке.",
    "vis_public_badge": "Публичная",
    "vis_public": "Открыть для всех",
    "vis_public_pending": "Ожидает проверки.",
    "vis_public_rejected": "Отклонено: ",
    "vis_public_sub": "Появится в публичной библиотеке после проверки.",
    "vis_unlisted_blocked": "Удалите пользовательское название/описание, чтобы поделиться по ссылке",
    "vis_unlisted": "Поделиться по ссылке",
    "vis_unlisted_sub": "Любой, у кого есть ссылка, может просматривать. Нигде не отображается.",
    ...
    "view_upstream": "Исходная запись",
    "api_docs": "Публичный API",
    "api_docs_desc": "Каталог доступен для чтения всем: без ключа и без ограничений на частоту запросов. Каждая конечная точка — обычный GET-запрос, возвращающий JSON, разрешает кросс-доменные вызовы с любого сайта и кэшируется на периферии 10 минут (кроме /api/random, который выбирает заново при каждом вызове). Каждая запись об игре содержит ID, название, автора, теги, движок, дату выхода, оценку, сложность, число отзывов, размер файла и ссылку на скачивание, адрес страницы на этом сайте и источник, откуда игра занесена в каталог.",
    "api_endpoints": "Конечные точки",
    "api_filters": "Фильтры (общие для всех конечных точек)",
    "api_examples": "Примеры",
    "api_notes": "Все фильтры выше используют один и тот же синтаксис и свободно комбинируются на любой конечной точке. Фильтры по тегам и движкам трёхпозиционные — ровно как в боковой панели: указанное значение требуется, суффикс _all требует все сразу, суффикс _not исключает; неуказанный фильтр ничего не отсеивает. Диапазоны дат складываются так же: несколько date_in расширяют выборку, а date_not вырезает из неё периоды. Игра без известной даты выхода не попадает ни в один диапазон, поэтому date_in её отбрасывает, а date_not не затрагивает. Некорректный параметр возвращает HTTP 400 с описанием ошибки, а не игнорируется молча, так что опечатка никогда не выглядит как «ничего не найдено».",
    ...
    "upload_mode_url": "Ссылка",
    "upload_mode_file": "Загрузить файл",
    "upload_pick": "Выберите файл",
    "upload_pick_sub": "ZIP · RAR · 7z · TAR · GZ · EXE — до 500 МБ",
    "upload_uploading": "Загрузка…",
    "upload_verifying": "Проверка…",
    "upload_done_help": "Загружено — файл будет прикреплён к этой заявке.",
    "upload_remove": "Удалить загруженный файл",
    "upload_retry": "Повторить",
    "upload_failed": "Не удалось загрузить",
    "upload_required_error": "Сначала загрузите файл игры.",
    "upload_bad_type": "Неподдерживаемый тип файла",
    "upload_too_large": "Файл превышает лимит 500 МБ",
    "upload_shot_too_large": "Изображение превышает лимит 8 МБ",
    "upload_shot_title": "Загрузить изображение",
    "upload_shot_busy": "Подождите — скриншот ещё загружается.",
  ...
  "fr": {
    ...
    "date_filter_label": "Période de sortie ({count})",
    "date_filter_add": "Ajouter",
    "date_filter_help": "Choisissez une date de début et/ou de fin puis ajoutez la période. Cliquez sur une période pour passer de inclure → exclure ; cliquez encore pour la retirer.",
    ...
    "collection_naming": "Nom",
    "mode_none": "Aucun",
    "mode_preset": "Préréglage",
    "mode_custom": "Personnalisé",
    "mode_none_help": "Aucun nom ni description — partageable instantanément par lien, sans révision.",
    "mode_preset_help": "Choisissez un nom prédéfini, sans description — partageable instantanément par lien, sans révision.",
    "mode_custom_help": "Écrivez votre propre nom et description. Le partage nécessite une soumission à la bibliothèque publique, qui est examinée.",
    "choose_preset": "Choisir un préréglage…",
    "show_owner_label": "Afficher mon nom d’utilisateur sur la page partagée",
    "mode_custom_public_parent": "La collection parente est publique — un nom/une description personnalisés n’y apparaîtront qu’après examen.",
    "collection_created_pending": "Enregistré — le nom/la description personnalisés apparaîtront publiquement après examen",
    "badge_pending": "En attente d’examen",
    "badge_rejected": "Rejetée",
    "vis_public_folder_sub": "Après examen, le dossier et ses sous-collections apparaîtront dans la bibliothèque publique.",
    "add_subcollection": "Ajouter une sous-collection",
    "add_to_collection": "Ajouter à la collection",
    "back": "Retour",
    "collection_created": "Collection créée",
    "collection_custom_notice": "Les noms et descriptions personnalisés ne peuvent être partagés que via « Ouvrir au public », qui est d'abord examiné. Un nom vide ou prédéfini sans description peut être partagé par lien instantanément.",
    "collection_desc": "Description",
    "collection_desc_ph": "Décrivez cette collection…",
    "collection_link_on": "Lien de partage activé",
    "collection_made_private": "Défini sur privé",
    "collection_name": "Nom",
    "collection_name_ph": "Nom de la collection",
    "collection_saved": "Collection enregistrée",
    "collection_submitted": "Envoyé pour examen",
    "collection_untitled": "Liste sans titre",
    "confirm_delete_collection": "Supprimer cette collection ? Cette action est irréversible.",
    "copy_link": "Copier",
    ...
    "edit": "Modifier",
    "edit_share": "Modifier et partager",
    "list_empty_sub": "Ajoutez des jeux depuis le menu « ajouter à la collection » de n'importe quel jeu.",
    "list_empty": "Cette liste est vide",
    "main_saves": "Sauvegardes principales",
    "menu": "Menu",
    "nav.public_collections": "Collections publiques",
    "new_collection_cta": "Nouvelle collection",
    "new_list_placeholder": "Nom de la nouvelle liste (facultatif)",
    "no_collections": "Aucune collection pour l'instant. Créez-en une pour organiser vos jeux enregistrés en listes partageables.",
    "optional": "facultatif",
    "publib_empty": "Aucune collection publique pour l'instant",
    "publib_empty_sub": "Les collections publiques approuvées et partagées par la communauté apparaîtront ici.",
    "publib_error_sub": "Veuillez réessayer.",
    "publib_sub": "Listes de jeux partagées par la communauté, examinées avant leur publication ici.",
    "save": "Enregistrer",
    "save_to": "Enregistrer dans…",
    "shared_collection": "Collection partagée",
    "shared_gone_sub": "Cette collection partagée n'existe plus ou est privée.",
    "shared_gone_title": "Collection indisponible",
    "sharing": "Partage",
    "submit_for_review": "Soumettre à la bibliothèque publique",
    "vis_private": "Privé",
    "vis_private_sub": "Vous seul pouvez voir ceci.",
    "vis_public_approved": "En ligne dans la bibliothèque publique.",
    "vis_public_badge": "Public",
    "vis_public": "Ouvrir au public",
    "vis_public_pending": "En attente d'examen.",
    "vis_public_rejected": "Rejeté : ",
    "vis_public_sub": "Répertorié dans la bibliothèque publique après examen.",
    "vis_unlisted_blocked": "Supprimez le nom/la description personnalisés pour partager par lien",
    "vis_unlisted": "Partager par lien",
    "vis_unlisted_sub": "Toute personne disposant du lien peut consulter. Non répertorié nulle part.",
    ...
    "view_upstream": "Fiche d'origine",
    "api_docs": "API publique",
    "api_docs_desc": "Le catalogue est lisible par tous, sans clé ni limite de débit. Chaque point d'entrée est une simple requête GET renvoyant du JSON, accepte les appels inter-domaines depuis n'importe quel site et reste en cache 10 minutes en périphérie (sauf /api/random, qui retire au sort à chaque appel). Chaque fiche de jeu contient son identifiant, son titre, son auteur, ses tags, son moteur, sa date de sortie, sa note, sa difficulté, son nombre d'avis, la taille et le lien de téléchargement, l'adresse de sa page sur ce site, ainsi que sa source de catalogage.",
    "api_endpoints": "Points d'entrée",
    "api_filters": "Filtres (communs à tous les points d'entrée)",
    "api_examples": "Exemples",
    "api_notes": "Tous les filtres ci-dessus partagent la même syntaxe et se combinent librement, sur n'importe quel point d'entrée. Les filtres de tags et de moteurs sont à trois états, exactement comme dans la barre latérale : une valeur seule l'exige, le suffixe _all les exige toutes, le suffixe _not l'exclut ; un filtre omis ne filtre rien. Les plages de dates se cumulent de la même façon : plusieurs date_in élargissent le résultat, date_not y découpe des périodes. Un jeu sans date de sortie connue n'appartient à aucune plage : date_in l'écarte donc, tandis que date_not le laisse tranquille. Un paramètre mal formé renvoie un HTTP 400 accompagné d'un message d'erreur au lieu d'être ignoré en silence, si bien qu'une faute de frappe ne ressemble jamais à un résultat vide.",
    ...
    "upload_mode_url": "Lien",
    "upload_mode_file": "Téléverser un fichier",
    "upload_pick": "Choisir un fichier",
    "upload_pick_sub": "ZIP · RAR · 7z · TAR · GZ · EXE — 500 Mo max",
    "upload_uploading": "Téléversement…",
    "upload_verifying": "Vérification…",
    "upload_done_help": "Téléversé — le fichier est joint à cette soumission.",
    "upload_remove": "Retirer le fichier téléversé",
    "upload_retry": "Réessayer",
    "upload_failed": "Échec du téléversement",
    "upload_required_error": "Veuillez d'abord téléverser le fichier du jeu.",
    "upload_bad_type": "Type de fichier non pris en charge",
    "upload_too_large": "Le fichier dépasse la limite de 500 Mo",
    "upload_shot_too_large": "L'image dépasse la limite de 8 Mo",
    "upload_shot_title": "Téléverser une image",
    "upload_shot_busy": "Veuillez patienter — une capture d'écran est encore en cours d'envoi.",
  ...
  "de": {
    ...
    "sort_date": "Veröffentlichungsdatum",
    "date_filter_label": "Veröffentlichungszeitraum ({count})",
    "date_filter_add": "Hinzufügen",
    "date_filter_help": "Start- und/oder Enddatum wählen und den Zeitraum hinzufügen. Klick auf einen Zeitraum wechselt einschließen → ausschließen; erneuter Klick entfernt ihn.",
    ...
    "collection_naming": "Benennung",
    "mode_none": "Keine",
    "mode_preset": "Vorlage",
    "mode_custom": "Eigene",
    "mode_none_help": "Kein Name und keine Beschreibung — sofort per Link teilbar, ohne Prüfung.",
    "mode_preset_help": "Vorgefertigten Namen wählen, keine Beschreibung — sofort per Link teilbar, ohne Prüfung.",
    "mode_custom_help": "Eigenen Namen und Beschreibung schreiben. Zum Teilen ist eine Einreichung in die öffentliche Bibliothek (mit Prüfung) nötig.",
    "choose_preset": "Vorlage wählen…",
    "show_owner_label": "Meinen Benutzernamen auf der geteilten Seite anzeigen",
    "mode_custom_public_parent": "Die übergeordnete Sammlung ist öffentlich — ein eigener Name/eine Beschreibung erscheint dort erst nach Prüfung.",
    "collection_created_pending": "Gespeichert — eigener Name/Beschreibung erscheinen öffentlich nach der Prüfung",
    "badge_pending": "Prüfung ausstehend",
    "badge_rejected": "Abgelehnt",
    "vis_public_folder_sub": "Nach der Prüfung erscheinen der Ordner und seine Untersammlungen in der öffentlichen Bibliothek.",
    "add_subcollection": "Untersammlung hinzufügen",
    "add_to_collection": "Zur Sammlung hinzufügen",
    "back": "Zurück",
    "collection_created": "Sammlung erstellt",
    "collection_custom_notice": "Benutzerdefinierte Namen und Beschreibungen können nur über „Öffentlich machen“ geteilt werden, was zuerst geprüft wird. Ein leerer oder voreingestellter Name ohne Beschreibung kann sofort per Link geteilt werden.",
    "collection_desc": "Beschreibung",
    "collection_desc_ph": "Beschreibe diese Sammlung…",
    "collection_link_on": "Freigabelink aktiviert",
    "collection_made_private": "Auf privat gesetzt",
    "collection_name": "Name",
    "collection_name_ph": "Sammlungsname",
    "collection_saved": "Sammlung gespeichert",
    "collection_submitted": "Zur Prüfung eingereicht",
    "collection_untitled": "Unbenannte Liste",
    "confirm_delete_collection": "Diese Sammlung löschen? Dies kann nicht rückgängig gemacht werden.",
    "copy_link": "Kopieren",
    ...
    "edit": "Bearbeiten",
    "edit_share": "Bearbeiten & teilen",
    "list_empty_sub": "Füge Spiele über das Menü „Zur Sammlung hinzufügen“ eines beliebigen Spiels hinzu.",
    "list_empty": "Diese Liste ist leer",
    "main_saves": "Haupt-Speicher",
    "menu": "Menü",
    "nav.public_collections": "Öffentliche Sammlungen",
    "new_collection_cta": "Neue Sammlung",
    "new_list_placeholder": "Name der neuen Liste (optional)",
    "no_collections": "Noch keine Sammlungen. Erstelle eine, um gespeicherte Spiele in teilbaren Listen zu organisieren.",
    "optional": "optional",
    "publib_empty": "Noch keine öffentlichen Sammlungen",
    "publib_empty_sub": "Genehmigte öffentliche Sammlungen, die von der Community geteilt wurden, erscheinen hier.",
    "publib_error_sub": "Bitte versuche es erneut.",
    "publib_sub": "Von der Community geteilte Spielelisten, die vor der Anzeige geprüft werden.",
    "save": "Speichern",
    "save_to": "Speichern in…",
    "shared_collection": "Geteilte Sammlung",
    "shared_gone_sub": "Diese geteilte Sammlung existiert nicht mehr oder ist privat.",
    "shared_gone_title": "Sammlung nicht verfügbar",
    "sharing": "Teilen",
    "submit_for_review": "Für öffentliche Bibliothek einreichen",
    "vis_private": "Privat",
    "vis_private_sub": "Nur du kannst dies sehen.",
    "vis_public_approved": "In der öffentlichen Bibliothek verfügbar.",
    "vis_public_badge": "Öffentlich",
    "vis_public": "Öffentlich machen",
    "vis_public_pending": "Prüfung ausstehend.",
    "vis_public_rejected": "Abgelehnt: ",
    "vis_public_sub": "Nach Prüfung in der öffentlichen Bibliothek gelistet.",
    "vis_unlisted_blocked": "Entferne den benutzerdefinierten Namen/die Beschreibung, um per Link zu teilen",
    "vis_unlisted": "Per Link teilen",
    "vis_unlisted_sub": "Jeder mit dem Link kann sie ansehen. Nirgendwo gelistet.",
    "your_collections": "Deine Sammlungen",
    ...
    "view_upstream": "Ursprungseintrag",
    "api_docs": "Öffentliche API",
    "api_docs_desc": "Der Katalog ist für alle lesbar — ohne Schlüssel und ohne Ratenbegrenzung. Jeder Endpunkt ist eine einfache GET-Anfrage, die JSON zurückgibt, erlaubt Cross-Origin-Aufrufe von jeder Website und wird 10 Minuten am Edge zwischengespeichert (außer /api/random, das bei jedem Aufruf neu zieht). Jeder Spieldatensatz enthält ID, Titel, Autor, Tags, Engine, Erscheinungsdatum, Bewertung, Schwierigkeit, Anzahl der Rezensionen, Dateigröße und Download-Link, die Seitenadresse auf dieser Website sowie die Quelle, aus der das Spiel katalogisiert wurde.",
    "api_endpoints": "Endpunkte",
    "api_filters": "Filter (für alle Endpunkte gleich)",
    "api_examples": "Beispiele",
    "api_notes": "Alle obigen Filter nutzen dieselbe Syntax und lassen sich an jedem Endpunkt frei kombinieren. Tag- und Engine-Filter sind dreiwertig, genau wie in der Seitenleiste: Ein Wert allein fordert ihn, das Suffix _all fordert alle, das Suffix _not schließt aus; ein weggelassener Filter filtert nichts. Datumsbereiche stapeln sich genauso — mehrere date_in erweitern das Ergebnis, date_not schneidet Zeiträume heraus. Ein Spiel ohne bekanntes Erscheinungsdatum liegt in keinem Bereich, wird von date_in also verworfen und von date_not nicht berührt. Ein fehlerhafter Parameter liefert HTTP 400 samt Fehlermeldung, statt still ignoriert zu werden — ein Tippfehler sieht damit nie wie ein leeres Ergebnis aus.",
    ...
    "upload_pick": "Datei auswählen",
    "upload_pick_sub": "ZIP · RAR · 7z · TAR · GZ · EXE — max. 500 MB",
    "upload_uploading": "Wird hochgeladen…",
    "upload_verifying": "Wird überprüft…",
    "upload_done_help": "Hochgeladen — die Datei ist dieser Einreichung beigefügt.",
    "upload_remove": "Hochgeladene Datei entfernen",
    "upload_retry": "Erneut versuchen",
    "upload_failed": "Hochladen fehlgeschlagen",
    "upload_required_error": "Bitte lade zuerst die Spieldatei hoch.",
    "upload_bad_type": "Nicht unterstützter Dateityp",
    "upload_too_large": "Datei überschreitet das 500-MB-Limit",
    "upload_shot_too_large": "Bild überschreitet das 8-MB-Limit",
    "upload_shot_title": "Bild hochladen",
    "upload_shot_busy": "Bitte warten — ein Screenshot wird noch hochgeladen.",
