...
window.TRANSLATIONS = {
  "en": {
    ...
    "update_log_desc": "A running record of database releases, new surfaces, and fixes shipped to the archive. The live database is currently on version {db_ver}. The application version is version {app_ver}.",
    ...
    "loading_update_log": "Loading update log...",
  ...
  "zh-CN": {
    ...
    "update_log_desc": "数据库版本发布、新界面和已推送至 archive 的修复程序的运行记录。当前在线数据库版本为 {db_ver}。应用程序版本为 {app_ver}。",
    "game_title": "游戏标题",
  ...
  "zh-TW": {
    ...
    "update_log_desc": "資料庫版本發布、新介面和已推送至 archive 的修復程式的運行記錄。目前線上資料庫版本為 {db_ver}。應用程式版本為 {app_ver}。",
    "game_title": "遊戲標題",
  ...
  "ja": {
    ...
    "update_log_desc": "データベースのリリース、新しいインターフェース、および archive に適用された修正の継続的な記録。現在の本番データベースのバージョンは {db_ver} です。アプリケーションのバージョンは {app_ver} です。",
    "game_title": "ゲームタイトル",
  ...
  "ko": {
    ...
    "update_log_desc": "데이터베이스 릴리스, 새로운 인터페이스, archive에 반영된 수정 사항에 대한 실행 기록입니다. 현재 라이브 데이터베이스 버전은 {db_ver}이며, 애플리케이션 버전은 {app_ver}입니다.",
    "game_title": "게임 제목",
    ...
    "go_to": "이동",
    "page_jump_of": "/ {total}",
    "loading_update_log": "업데이트 로그 불러오는 중...",
  ...
  "ru": {
    ...
    "update_log_desc": "Текущий журнал выпусков баз данных, новых интерфейсов и исправлений, отправленных в archive. Рабочая база данных в данный момент имеет версию {db_ver}. Версия приложения: {app_ver}.",
    ...
    "loading_update_log": "Загрузка журнала обновлений...",
  ...
  "fr": {
    ...
    "update_log_desc": "Un enregistrement continu des versions de la base de données, des nouvelles interfaces et des correctifs déployés sur l'archive. La base de données en direct est actuellement en version {db_ver}. La version de l'application est la version {app_ver}.",
    ...
    "loading_update_log": "Chargement du journal des mises à jour...",
  ...
  "de": {
    ...
    "update_log_desc": "Eine fortlaufende Aufzeichnung von Datenbank-Releases, neuen Oberflächen und Korrekturen, die an das archive übermittelt wurden. Die Live-Datenbank hat derzeit die Version {db_ver}. Die Anwendungsversion ist Version {app_ver}.",
    ...
    "loading_update_log": "Änderungsprotokoll wird geladen...",
