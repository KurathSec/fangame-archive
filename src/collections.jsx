      ...
      <div className="col-layout">
        ...
        <main className="col-work">
            ...
            {games.map((g, i) => (
              ...
              >
                ...
                <div>
                  ...
                  <div className="gcreator">by {g.creator} · <span className="mono">★ {g.rating.toFixed(1)}</span> · <span className="mono">diff {g.difficulty}</span></div>
                </div>
          ...
          <div style={{ marginTop: 14, display: 'flex', gap: 8, fontSize: 12, color: 'var(--muted)' }}>
            ...
            <span>·</span>
            <span className="mono">avg diff {games.length ? Math.round(games.reduce((s, g) => s + g.difficulty, 0) / games.length) : '—'}</span>
          </div>
        </main>
      </div>
    </>
